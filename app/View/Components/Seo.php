...
class Seo extends Component
{
    ...
    public function __construct(
        ...
        // Seivar - Lebanese Contracting Agency defaults
        $currentLocale = app()->getLocale();

        $defaultTitles = [
            'ar' => 'سيفار - وكالة مقاولات لبنانية متكاملة الخدمات',
            'en' => 'Seivar - Full-Service Lebanese Contracting Agency'
        ];

        $defaultDescriptions = [
            'ar' => 'سيفار هي وكالة مقاولات لبنانية متكاملة الخدمات متخصصة في تجديد الواجهات، تحويل التصميم الداخلي، وتنسيق البنية التحتية. نربط النقاط بين التصميم والتنفيذ والتسليم بسلاسة.',
            'en' => 'Seivar is a full-service Lebanese contracting agency specializing in façade renovation, interior transformation, and infrastructure coordination. We connect the dots between design, execution, and delivery—seamlessly.'
        ];

        $defaultKeywords = [
            'ar' => 'مقاولات لبنان, تجديد واجهات, تصميم داخلي, ترميم مباني, تنسيق بنية تحتية, أعمال واجهات, تنفيذ تصميم داخلي, مقاولات عامة, تشطيبات فاخرة, شركة مقاولات',
            'en' => 'Lebanon contracting, façade renovation, interior design, building restoration, infrastructure coordination, façade works, interior execution, general contracting, luxury finishes, construction agency'
        ];
        ...
        $this->image = $image ?? asset('assets/images/logos/logo.svg');
